...
**Current branch:** `test` is the integration branch; as of the v0.53.0 cut it holds the design-system audit release (audit doc + #107 batches 1–5 + final sweep + #106 fix, PRs #108–#116), promoted to `main` as the v0.53.0 release — plus the post-release UI fixes `386d7fc` and `7095606`, promoted alongside. Re-check drift before each push (see the branch note in the State paragraph above).
