...
**A shared itinerary stops shipping an oversized cover, stops printing its own content twice, and the gallery stops featuring an itinerary it cannot vouch for — or showing the same plan twice.**
