...
Current version: **0.62.0** on `test` (M6 · Together's co-editing half — B1 presence, B2 stale-update guard, B3 remote-edit banner, B4 mark-settled, B0 write-through fixes), pending promotion; `main` carries **0.61.0** — promoted on 2026-09-18 (**PR #259**).
